    ...
    function transform($menu_arr){
        ...
        for($i=0; $i<count($menu_arr);$i++){
            ...
            if(is_array($menu_arr[$i][$key[0]])){
                ...
                $html .= "<li class='menu_element list_".$key[0]." ".@$selected."'><a href='' class='element-link'>".$key[0]."</a><ul class='sub_menu_".$key[0]."'>";
                ...
                $html .= "<li class='menu_element list_".$this->class_format(strtolower($key[0]))." ".$selected."'><a class='element-link lnk_list_".$this->class_format(strtolower($key[0]))."' href='".$this->class_format(strtolower(utf8_encode($menu_arr[$i][$key[0]])))."'>".$key[0]."</a></li>";                
            }            
        }
        $html .= "</ul>";
