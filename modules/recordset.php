...
?>
    <div class="sidebar">
        <div class="desc-section side">
            <h2>
                <?
                    if(!isset($other_title)) echo ucwords($db_table); 
                    else echo ucwords($other_title); 
                ?>
            </h2>
            <p><?= $description ?></p>
        </div>
    ...
    <div class="main-options">
        <?php 
        if(isset($options["Nuevo FTP"])){
        ?>
        <a href="/happycms/galleries/ftp" class="main-options-option main-options-extra-option btn btn-small btn-success"><i class="icon-arrow-up icon-white"></i> Nuevo FTP</a>
        <?php    
        }
    ...
    if(isset($options)){
        ...
        ?>        
            <a href="<?= $href ?>" style="color:#333;" onclick="<?= $onclick ?>" class="main-options-option main-options-extra-option btn btn-small main-options-<?= $option_keys[$i] ?>"><?= $option_keys[$i] ?></a>
        <?php
                }    
            }            
        }
    ...
    ?>
    <input type="text" id="FilterTextBox" placeholder="Filtro de busqueda" class="span4" style="margin-bottom: 0;"/>
