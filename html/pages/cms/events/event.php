<?php
    ...
    $forms = new Forms($select_row,"events",$id,$link);

    $forms->create(array("id"=>"events-form", "data-form" => "events"));    
    $forms->input("name","Name (*)",array("class"=>'required input-xlarge'));
    $forms->input("place","Place (*)",array("class"=>'required input-xlarge'));
    $forms->input("event_date","Event Date (*)",array("class"=>'required input-xlarge'));
    $forms->input("schedule","Schedule (*)",array("class"=>'required input-xlarge'));
    $forms->input("box_office","Box Office (Taquilla)",array("class"=>'input-xlarge'));
    ...
    $forms->input("extra_information","Extra Info",array("class"=>'input-xlarge'));
