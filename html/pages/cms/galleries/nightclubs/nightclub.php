<?php
    $table = "nightclubs";
    $description = "Area for Culichi beautiful antros";
    $id = $get;
    $redirect_url = "nightclubs/nightclub";
    ...
    $forms = new Forms($select_row,"nightclubs",$id,$link);

    $forms->create(array("id"=>"nightclubs-form", "data-form" => "nightclubs"));    
