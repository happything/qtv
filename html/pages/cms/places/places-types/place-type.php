<?php
    ...
    $id = $get;
    $redirect_url = "places/places-types";
    ...
    $forms = new Forms($select_row,"places_types",$id,$link);

    $forms->create(array("id"=>"places_types-form", "data-form" => "places_types"));    
